...
//     });
    ...
    public AdvancedProspectorItem(Properties properties) {
        super(properties);
    }
...
//                 user.sendMessage(
//                     Text.translatable(getDescriptionId() + ".use.done").formatted(Formatting.GREEN),
//                     true);
...
//             } else {
//                 user.sendMessage(
//                     Text.translatable(getDescriptionId() + ".use.done").formatted(Formatting.RED),
//                     true);
//                 world.playSoundFromEntity(null, user,
...
//                 ModItems.ADVANCED_PROSPECTOR.getDescriptionId() + ".tooltip").formatted(Formatting.GRAY));
//         }
//     }
